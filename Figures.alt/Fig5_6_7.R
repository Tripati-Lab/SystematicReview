...
ds <- here::here("Analyses", "Results.alt", "50_Obs")
...
pdf(here::here("Figures.alt","Plots","Fig5.pdf"),10,8)
print(p1)
dev.off()

jpeg(here::here("Figures.alt","Plots","Fig5.jpg"), 10, 8, units = "in", res=300)
print(p1)
dev.off()

pdf(here::here("Figures.alt","Plots","Fig6.pdf"),10,8)
print(p2)
dev.off()

jpeg(here::here("Figures.alt","Plots","Fig6.jpg"), 10, 8, units = "in", res=300)
print(p2)
dev.off()

pdf(here::here("Figures.alt","Plots","Fig7.pdf"),10,8)
print(p3)
dev.off()

jpeg(here::here("Figures.alt","Plots","Fig7.jpg"), 10, 8, units = "in", res=300)
print(p3)
dev.off()
