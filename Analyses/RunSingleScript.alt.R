...
write.csv(ParamEstimates, here::here("Analyses","Results.alt",paste0(samples,"_Obs"),paste0(name,"Replicates=", replicates,"Samples=",samples,priors ,"_ParameterEstimates.csv")))
write.csv(RecComplete, here::here("Analyses","Results.alt",paste0(samples,"_Obs"), paste0(name,"Replicates=", replicates,"Samples=",samples,priors ,"_Recs.csv" )))
write.csv(Params, here::here("Analyses","Results.alt",paste0(samples,"_Obs"),paste0(name,"Replicates=", replicates,"Samples=",samples,priors ,"_ParamsFull.csv" )))
